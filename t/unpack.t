...
cmp_ok(unpack_bf16_hex(Math::Bfloat16->new(Math::MPFR->new('5e-41'))), 'eq', '0001', "MPFR('5e-41') unpacks correctly");
...
cmp_ok(unpack_bf16_hex(Math::Bfloat16->new(Math::MPFR->new('-5e-41'))), 'eq', '8001', "MPFR('5e-41') unpacks correctly");
