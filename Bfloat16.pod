...
=head1 ASSIGNMENT FUNCTIONS
    ...
    $obj = Math::Bfloat16::new([$val]);
     ...
     a Math::Bfloat16 object, or a Math::Float32 object, a Math::MPFR
     ...
     If $val is a Math::Float32 then rounding will be towards zero;
     otherwise rounding will be towards nearest, with ties to even).
...
=head1 ARITHMETIC
 ...
 The overloaded operations accept IVs, NVs, PVs, Math::Float32
 objects and Math::Bfloat16 objects.
 Math::Float32 objects will be truncated (rounded towards
 zero) to Math::Bloat16 objects.
